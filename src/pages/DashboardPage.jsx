      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link
              to="/students/add"
              className="bg-blue-100 hover:bg-blue-200 text-blue-800 p-4 rounded-lg flex flex-col items-center"
            >
            ...
            <Link
              to="/fees"
              className="bg-green-100 hover:bg-green-200 text-green-800 p-4 rounded-lg flex flex-col items-center"
            >
            ...
            <Link
              to="/attendance"
              className="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 p-4 rounded-lg flex flex-col items-center"
            >
            ...
            <Link
              to="/reports"
              className="bg-purple-100 hover:bg-purple-200 text-purple-800 p-4 rounded-lg flex flex-col items-center"
            >
